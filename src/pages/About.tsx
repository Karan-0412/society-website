...
const About = () => {
  ...
  return (
    <div className='space-y-10 max-h-screen'>
        <Header />
        ...
        <section className="hero-gradient text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              "Getting to know someone is a beautiful process"
            </p>
          </div>
        </section>

        {/* Left  Tile */}
        <main className='flex lg:flex-row sm:flex-col justify-center items-center min-w-screen'>
          <section className='w-[50%]'>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6 mx-10 ">
          ...
          {/* Right Tile - Highlights */}

          <div className='w-[50%] flex flex-col justify-center items-center'>
            <h2 className='text-3xl font-semibold'>High<span className='text-pink-300'>lights</span> </h2>
            <AnimatePresence>
